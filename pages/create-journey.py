...
class CreateJourneyFormPage(Page):
    ...
    def create_journey(self):
        ...
        self.db.insert_new_train_schedule(
            universe=universe,
            description=description,
    ...
    def render_header(self):
        ...
        st.subheader("🚄 Create a New Journey!")
        st.write("Please fill in the form below to create your journey.")
        st.divider()
    ...
    def render_submit_button(self):
        ...
        if create_journey_button:
            try:
                ...
                ErrorToast(
                    "Oops... something went wrong while trying to create your journey. "
